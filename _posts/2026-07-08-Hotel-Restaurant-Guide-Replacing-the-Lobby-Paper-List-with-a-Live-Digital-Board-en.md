---
layout: post
title: Hotel Restaurant Guide - Replacing the Lobby Paper List with a Live Digital Board
date: 2026-07-08 00:00:00 +0000
tags: hotel
image: /assets/2026-07-08-11-02-16/title.jpg
bg_alternative: true
description: "Turn the outdated printed restaurant list in your hotel lobby into a live, self-service digital board that reception can keep current in seconds."
prompt: |
  An app for a hotel to provide guest information. There's a piece of paper
  hanging here that's always out of date, listing the best restaurants in the
  surrounding area. Create this in a digital way with two screens one showing
  the guest information about the restaurants and a screen for the hotel crew
  with pin board for authentication and the posibility to add restaurants.
downloads:
  - name: Peakboard.pbmx
    url: /assets/2026-07-08-11-02-16/Peakboard.pbmx
lang: en
...
![Guest view showing the Dining Around the Hotel restaurant board](/assets/2026-07-08-11-02-16/010.png)
...
![Crew back-office with PIN keypad and the restaurant management form](/assets/2026-07-08-11-02-16/020.png)
